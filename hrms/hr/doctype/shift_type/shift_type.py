...
from hrms.hr.doctype.shift_assignment.shift_assignment import get_employee_shift, get_shift_details ,glovis_get_shift_details
...
class ShiftType(Document):
	...
	def process_auto_attendance(self):
		...
		# print("process_auto_attendance ---logs ---",logs)
		# print("\n\n\n\n\n\n\n\n")

		for key, group in itertools.groupby(
			logs, key=lambda x: (x["employee"], x["shift_actual_start"],x["shift_attendance_date"])
		):
			...
			# print("single_shift_logs--",single_shift_logs)
			# print("\n\n\n\n\n\n\n\n")
	...
	def get_attendance(self, logs):
		...
		if not out_time :
			attendance_status = "Missed Punch"
			return attendance_status, total_working_hours, late_entry, early_exit, in_time, out_time
	...
	def get_start_and_end_dates(self, employee):
		...
		shift_details = glovis_get_shift_details(self.name, get_datetime(self.last_sync_of_checkin))
		last_shift_time = (
